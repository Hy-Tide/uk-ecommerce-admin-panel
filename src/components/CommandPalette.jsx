...
export const CommandPalette = ({
  ...
  const commands = [
    ...
    { type: 'navigation', label: 'Go to Customer Enquiries', key: 'enquiries', section: 'Navigation' },
    { type: 'navigation', label: 'Go to Coupons & Promotions', key: 'coupons', section: 'Navigation' },
    { type: 'navigation', label: 'Go to Analytics Reports', key: 'reports', section: 'Navigation' },
