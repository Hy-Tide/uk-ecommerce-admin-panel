  ...
  homeSections: [
    {
      ...
      title: 'Organic Grocery, Fresh Delivery',
      subtitle: 'Handpicked fresh organic products from local crops directly to your doorsteps.',
      enabled: true,
      displayOrder: 1,
      dataSource: 'manual',
      productLimit: null,
      ...
      items: [],
      customContent: [
        { id: 'slide-1', title: 'Organic Grocery, Fresh Delivery', subtitle: 'Handpicked fresh organic products from local crops directly to your doorsteps.', imageUrl: 'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&q=80&w=800', buttonText: 'Shop Now', buttonUrl: '/shop' }
      ]
    },
    {
      id: 'sec-features',
      sectionType: 'Feature Highlights',
      title: 'Our Customer Commitments',
      subtitle: 'Why people choose Grandma\'s Basket for their weekly fresh delivery.',
      enabled: true,
      displayOrder: 2,
      dataSource: 'manual',
      productLimit: null,
      ...
      items: [],
      customContent: [
        { id: 'feat-1', title: 'Free Shipping', description: 'On all orders above $35', icon: 'Truck' },
        { id: 'feat-2', title: '100% Organic', description: 'Certified local farm produce', icon: 'Award' },
        { id: 'feat-3', title: 'Secure Payment', description: 'Secure protected payment gateway', icon: 'ShieldCheck' }
      ]
    },
    {
      id: 'sec-promo-grid',
      sectionType: 'Promotional Banner Grid',
      title: 'Seasonal Offers',
      subtitle: 'Grab fresh discounts on organic greens and artisan bakery items.',
      enabled: true,
      displayOrder: 3,
      dataSource: 'manual',
      productLimit: null,
      ...
      items: [],
      customContent: [
        { id: 'promo-1', title: 'Fresh Avocados Special', description: 'Grab organic avocados pack at 25% discount.', imageUrl: 'https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?auto=format&fit=crop&q=80&w=400', buttonText: 'Buy Now', buttonUrl: '/shop?search=avocado' },
        { id: 'promo-2', title: 'Artisan Oven Loaves', description: 'Freshly baked sourdough and chocolate chip cookies.', imageUrl: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?auto=format&fit=crop&q=80&w=400', buttonText: 'Browse Bakery', buttonUrl: '/shop?category=Bakery' }
      ]
    },
    {
      id: 'sec-categories',
      ...
      subtitle: 'Browse through our premium selection of organic grocery categories.',
      enabled: true,
      displayOrder: 4,
      dataSource: 'manual',
      productLimit: 6,
    ...
    {
      id: 'sec-best-deals',
      sectionType: 'Best Deals',
      title: 'Super Saver Deals',
      subtitle: 'Enjoy the lowest prices of the week on organic pantry supplies.',
      enabled: true,
      displayOrder: 5,
      ...
      buttonUrl: '/shop?filter=deals',
      items: []
    },
    {
      id: 'sec-limited-products',
      sectionType: 'Limited Products',
      title: 'Limited Stock Items',
      subtitle: 'Hurry up! These fresh farm goods are selling out fast.',
      enabled: true,
      displayOrder: 6,
      dataSource: 'automatic',
      productLimit: 4,
      ...
      buttonText: 'View Fast Sellers',
      buttonUrl: '/shop?filter=limited',
      items: []
    },
    {
      id: 'sec-recommended-products',
      sectionType: 'Recommended Products',
      title: 'Recommended For You',
      subtitle: 'Personalized organic selections based on top ratings.',
      enabled: true,
      displayOrder: 7,
      dataSource: 'automatic',
      productLimit: 4,
    ...
    },
    {
      ...
      title: 'Just Arrived at Warehouse',
      subtitle: 'Sourced within the last 24 hours from local community green houses.',
      enabled: true,
      displayOrder: 8,
      dataSource: 'automatic',
      productLimit: 4,
    ...
    },
    {
      ...
      subtitle: 'Items you have recently inspected.',
      enabled: true,
      displayOrder: 9,
      dataSource: 'automatic',
      productLimit: 4,
    ...
    },
    {
      ...
      title: 'Our Featured Picks',
      subtitle: 'Handpicked quality products recommended by our dieticians.',
      enabled: true,
      displayOrder: 10,
      dataSource: 'manual',
      productLimit: 4,
      filters: {},
      buttonText: 'View Featured List',
      buttonUrl: '/shop?filter=featured',
      items: ['prod-1', 'prod-2', 'prod-3', 'prod-7']
    },
    {
      id: 'sec-trending-products',
      sectionType: 'Trending Products',
      title: 'Trending This Week',
      subtitle: 'Popular choices among families in the neighborhood.',
      enabled: false,
      displayOrder: 11,
      dataSource: 'automatic',
      productLimit: 4,
      ...
      buttonUrl: '/shop?filter=trending',
      items: []
    },
    {
      id: 'sec-best-sellers',
      ...
      subtitle: 'Guaranteed customer favorites with hundreds of 5-star ratings.',
      enabled: true,
      displayOrder: 12,
      dataSource: 'automatic',
      productLimit: 4,
      ...
      buttonUrl: '/shop?filter=bestsellers',
      items: []
    },
    {
      id: 'sec-brands',
      ...
      subtitle: 'Certified organic growers and sustainable dairies we work with.',
      enabled: true,
      displayOrder: 13,
      dataSource: 'manual',
      productLimit: 10,
      ...
      buttonUrl: '/brands',
      items: ['br-1', 'br-2', 'br-3', 'br-4']
    },
    {
      id: 'sec-recipes',
      sectionType: 'Recipes',
      title: 'Cook with Organic Freshness',
      subtitle: 'Try delicious dishes using ingredients directly from your cart.',
      enabled: true,
      displayOrder: 14,
      dataSource: 'manual',
      productLimit: 3,
    ...
    },
    {
      ...
      subtitle: 'Read genuine reviews and shopping experiences from verified buyers.',
      enabled: true,
      displayOrder: 15,
      dataSource: 'manual',
      productLimit: null,
      ...
      items: [],
      customContent: [
        { id: 'test-1', name: 'Sarah Jenkins', role: 'Avocado Enthusiast', rating: 5, feedback: 'Grandma\'s Basket avocados are always perfectly ripe and creamy. Free delivery is super fast!', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=facearea&facepad=2&w=120&h=120&q=80' },
        { id: 'test-2', name: 'Michael Chang', role: 'Home Baker', rating: 5, feedback: 'The wild sourdough is out of this world! It has a perfect blistered crust and tangy taste.', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=facearea&facepad=2&w=120&h=120&q=80' }
      ]
    },
    {
      ...
      subtitle: 'How we deliver superior farm produce direct to your doorstep.',
      enabled: true,
      displayOrder: 16,
      dataSource: 'manual',
      productLimit: null,
      ...
      items: [],
      customContent: [
        { id: 'reason-1', title: 'Harvested Daily', description: 'Fresh vegetables are cut, washed, and packed the very morning of your shipping dispatch.', imageUrl: 'https://images.unsplash.com/photo-1610348725531-843dff163e2c?auto=format&fit=crop&q=80&w=400' },
        { id: 'reason-2', title: 'Cold-Chain Staging', description: 'Dairy items and fresh berries are stored in our advanced -2°C cold chambers until driver loading.', imageUrl: 'https://images.unsplash.com/photo-1550583724-b2692b85b150?auto=format&fit=crop&q=80&w=400' }
      ]
    },
    {
      id: 'sec-newsletter',
      sectionType: 'Newsletter',
      title: 'Subscribe to Our Green Newsletter',
      subtitle: 'Get 10% off your first checkout, plus exclusive recipe tips and flash crop alerts.',
      enabled: true,
      displayOrder: 17,
      dataSource: 'manual',
      productLimit: null,
...
export const INITIAL_OFFERS = [
  {
    id: 'offer-1',
    _id: 'offer-1',
    title: 'Festive Grocery Sale',
    name: 'Festive Grocery Sale',
    description: 'Get up to 30% OFF on organic fruits, daily essentials, and baking ingredients.',
  ...
  },
  {
    ...
    name: 'Weekend Mega Savings',
    description: 'Special weekend discounts on fresh dairy, beverages, and pantry staples.',
    bannerImage: 'https://images.unsplash.com/photo-1578916171728-46686eac8d58?auto=format&fit=crop&q=80&w=600',
  ...
  },
  {
    id: 'offer-3',
    _id: 'offer-3',
    title: 'Monsoon Healthy Snack Fest',
    name: 'Monsoon Healthy Snack Fest',
    description: 'Exclusive combo offers on nuts, organic chips, and herbal tea selections.',
    bannerImage: 'https://images.unsplash.com/photo-1610832958506-aa56368176cf?auto=format&fit=crop&q=80&w=600',
